            ...
            <section class="flex flex-col gap-5">
                ...
                <div class="info-card flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-2xl p-[18px_14px] gap-3 bg-[#F4F4F6]">
                        ...
                        <div class="flex flex-col gap-1">
                            <p class="font-semibold">{{ $details->started_at->format('j F Y') }}</p>
                        </div>
                    </div>
                </div>
                <div class="info-card flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-2xl p-[18px_14px] gap-3 bg-[#F4F4F6]">
                        ...
                        <div class="flex flex-col gap-1">
                            <p class="font-semibold">{{ $details->ended_at->format('j F Y') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="info-card flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-2xl p-[18px_14px] gap-3 bg-[#F4F4F6]">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <p class="text-sm leading-[21px] text-[#6E6E70]">{{ $details->store->addres }}</p>
                        </div>
                    </div>
                </div>
                @endif
                
                @if ($details->delivery_type == 'home_delivery')
                <div class="info-card flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-2xl p-[18px_14px] gap-3 bg-[#F4F4F6]">
                        ...
                        <div class="flex flex-col gap-1">
                            <p class="font-semibold">{{ $details->addres }}</p>
                        </div>
                    </div>
                </div>
                @endif
